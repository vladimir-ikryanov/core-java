...
var jspb = {
    ExtensionFieldInfo: function (a, b, c, d, e, f, g, h, k, l) {
        this.fieldIndex = a;
        this.fieldName = b;
        this.ctor = c;
        this.toObjectFn = d;
        this.binaryReaderFn = f;
        this.binaryWriterFn = g;
        this.binaryMessageSerializeFn = h;
        this.binaryMessageDeserializeFn = k;
        this.isRepeated = e;
        this.isPacked = l
    }, Message: function () {
    }
...
jspb.Message.initialize = function (a, b, c, d, e, f) {
    ...
    if (e)for (b = 0; b < e.length; b++)c = e[b], c < a.pivot_ ? (c = jspb.Message.getIndex_(a, c), a.array[c] = a.array[c] || (jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS ? jspb.Message.EMPTY_LIST_SENTINEL_ : [])) : a.extensionObject_[c] = a.extensionObject_[c] || (jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS ?
...
jspb.Message.materializeExtensionObject_ = function (a, b) {
    if (a.array.length) {
        ...
        if (d && "object" == typeof d && !goog.isArray(d)) {
...
jspb.Message.serializeBinaryExtensions = function (a, b, c, d) {
    for (var e in c) {
        ...
        var g = d.call(a, f);
        if (g)if (f.ctor)if (f.binaryMessageSerializeFn)f.binaryWriterFn.call(b, f.fieldIndex, g, f.binaryMessageSerializeFn); else throw Error("Message extension present holding submessage without binary support enabled, and message is being serialized to binary format"); else f.binaryWriterFn.call(b,
            f.fieldIndex, g)
    }
};
jspb.Message.readBinaryExtension = function (a, b, c, d, e) {
    if (c = c[b.getFieldNumber()]) {
        if (!c.binaryReaderFn)throw Error("Deserializing extension whose generated code does not support binary format");
        var f;
        c.ctor ? (f = new c.ctor, c.binaryReaderFn.call(b, f, c.binaryMessageDeserializeFn)) : f = c.binaryReaderFn.call(b);
        c.isRepeated && !c.isPacked ? (b = d.call(a, c)) ? b.push(f) : e.call(a, c, [f]) : e.call(a, c, f)
    } else b.skipField()
};
...
jspb.Message.prototype.getExtension = function (a) {
    if (this.extensionObject_) {
        ...
        var b = a.fieldIndex;
        if (a.isRepeated) {
            if (a.ctor)return this.wrappers_[b] || (this.wrappers_[b] = goog.array.map(this.extensionObject_[b] || [], function (b) {
                return new a.ctor(b)
            })), this.wrappers_[b]
        } else if (a.ctor)return !this.wrappers_[b] && this.extensionObject_[b] && (this.wrappers_[b] = new a.ctor(this.extensionObject_[b])), this.wrappers_[b];
...
jspb.Message.prototype.setExtension = function (a, b) {
    ...
    var c = a.fieldIndex;
    a.isRepeated ? (b = b || [], a.ctor ? (this.wrappers_[c] = b, this.extensionObject_[c] = goog.array.map(b, function (a) {
        return a.toArray()
    })) : this.extensionObject_[c] = b) : a.ctor ? (this.wrappers_[c] = b, this.extensionObject_[c] = b ? b.toArray() : b) : this.extensionObject_[c] = b
};
...
jspb.Message.compareFields = function (a, b) {
    if (goog.isObject(a) && goog.isObject(b)) {
        var c = {}, d, e, f;
        for (d in a)a.hasOwnProperty(d) && (c[d] = 0);
        for (d in b)b.hasOwnProperty(d) && (c[d] = 0);
        for (d in c) {
            var c = a[d], g = b[d];
            if (goog.isObject(c) && !goog.isArray(c)) {
                if (void 0 !== e)throw Error("invalid jspb state");
                e = goog.object.isEmpty(c) ? void 0 : c;
                c = void 0
            }
            if (goog.isObject(g) && !goog.isArray(g)) {
                if (void 0 !== f)throw Error("invalid jspb state");
                f = goog.object.isEmpty(g) ? void 0 : g;
                g = void 0
            }
            if (!jspb.Message.compareFields(c, g))return !1
        }
        return e ||
        f ? jspb.Message.compareFields(e, f) : !0
    }
    return a == b
};
...
jspb.utils.cloneRepeatedScalarField = function (a) {
    return a ? a.slice() : null
};
jspb.utils.cloneRepeatedMessageField = function (a, b) {
    if (null === a)return null;
    for (var c = [], d = 0; d < a.length; d++)c.push(b(a[d]));
    return c
};
jspb.utils.cloneRepeatedBlobField = function (a) {
    if (null === a)return null;
    for (var b = [], c = 0; c < a.length; c++)b.push(new Uint8Array(a[c]));
    return b
};
jspb.utils.debugBytesToTextFormat = function (a, b) {
    var c = '"';
    if (a)for (var d = jspb.utils.byteSourceToUint8Array(a, b), e = 0; e < d.length; e++)c += "\\x", 16 > d[e] && (c += "0"), c += d[e].toString(16);
    return c + '"'
};
jspb.utils.debugScalarToTextFormat = function (a) {
    return goog.isString(a) ? goog.string.quote(a) : a.toString()
};
jspb.utils.stringToByteArray_ = function (a) {
...
jspb.utils.byteSourceToUint8Array = function (a, b) {
    if (a.constructor === Uint8Array)return a;
    if (a.constructor === ArrayBuffer || a.constructor === Array)return new Uint8Array(a);
    if (a.constructor === String)return b ? jspb.utils.stringToByteArray_(a) : goog.crypt.base64.decodeStringToUint8Array(a);
...
jspb.BinaryDecoder.prototype.readBytes = function (a) {
    if (0 > a || this.cursor_ + a > this.bytes_.length)return this.error_ = !0, null;
...
jspb.BinaryWriter.prototype.appendUint8Array_ = function (a) {
    this.temp_.length && this.saveTempBuffer_();
    this.blocks_.push(a);
    this.totalLength_ += a.length
};
jspb.BinaryWriter.prototype.appendArray_ = function (a) {
    this.temp_.length && this.saveTempBuffer_();
    this.temp_ = a
};
...
jspb.BinaryWriter.prototype.endDelimited_ = function (a) {
    var b = this.totalLength_ + this.temp_.length - a.length;
    goog.asserts.assert(0 <= b);
    for (var c = 1; 127 < b;)a.block.push(b & 127 | 128), b >>>= 7, c++;
    a.block.push(b);
    this.totalLength_ += c
};
...
jspb.BinaryWriter.prototype.getResultBuffer = function () {
    ...
    for (var a = new Uint8Array(this.totalLength_ + this.temp_.length), b = this.blocks_, c = b.length, d = 0, e = 0; e < c; e++) {
        var f = b[e];
        a.set(f, d);
        d += f.length
    }
...
jspb.BinaryWriter.prototype.rawWriteUnsignedVarint32 = function (a) {
    for (goog.asserts.assert(a == Math.floor(a)); 127 < a;)this.temp_.push(a & 127 | 128), a >>>= 7;
    this.temp_.push(a)
};
jspb.BinaryWriter.prototype.rawWriteSignedVarint32 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    if (0 <= a)this.rawWriteUnsignedVarint32(a); else {
        for (var b = 0; 9 > b; b++)this.temp_.push(a & 127 | 128), a >>= 7;
        this.temp_.push(1)
    }
};
jspb.BinaryWriter.prototype.rawWriteSplitVarint = function (a, b) {
    for (; 0 < b || 127 < a;)this.temp_.push(a & 127 | 128), a = (a >>> 7 | b << 25) >>> 0, b >>>= 7;
    this.temp_.push(a)
};
jspb.BinaryWriter.prototype.rawWriteVarint = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    jspb.utils.splitInt64(a);
    this.rawWriteSplitVarint(jspb.utils.split64Low, jspb.utils.split64High)
};
jspb.BinaryWriter.prototype.rawWriteVarintFromNum = function (a) {
    this.rawWriteSplitVarint(a.lo, a.hi)
};
jspb.BinaryWriter.prototype.rawWriteZigzagVarint32 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    this.rawWriteUnsignedVarint32((a << 1 ^ a >> 31) >>> 0)
};
jspb.BinaryWriter.prototype.rawWriteZigzagVarint = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    jspb.utils.splitZigzag64(a);
    this.rawWriteSplitVarint(jspb.utils.split64Low, jspb.utils.split64High)
};
jspb.BinaryWriter.prototype.rawWriteUint8 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    goog.asserts.assert(0 <= a && 256 > a);
    this.temp_.push(a >>> 0 & 255)
};
jspb.BinaryWriter.prototype.rawWriteUint16 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    goog.asserts.assert(0 <= a && 65536 > a);
    this.temp_.push(a >>> 0 & 255);
    this.temp_.push(a >>> 8 & 255)
};
jspb.BinaryWriter.prototype.rawWriteUint32 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    goog.asserts.assert(0 <= a && a < jspb.BinaryConstants.TWO_TO_32);
    this.temp_.push(a >>> 0 & 255);
    this.temp_.push(a >>> 8 & 255);
    this.temp_.push(a >>> 16 & 255);
    this.temp_.push(a >>> 24 & 255)
};
jspb.BinaryWriter.prototype.rawWriteUint64 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
...
jspb.BinaryWriter.prototype.rawWriteInt8 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    goog.asserts.assert(-128 <= a && 128 > a);
    this.temp_.push(a >>> 0 & 255)
};
jspb.BinaryWriter.prototype.rawWriteInt16 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    goog.asserts.assert(-32768 <= a && 32768 > a);
    this.temp_.push(a >>> 0 & 255);
    this.temp_.push(a >>> 8 & 255)
};
jspb.BinaryWriter.prototype.rawWriteInt32 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
...
jspb.BinaryWriter.prototype.rawWriteInt64 = function (a) {
    goog.asserts.assert(a == Math.floor(a));
...
jspb.BinaryWriter.prototype.rawWriteFloat = function (a) {
    jspb.utils.splitFloat32(a);
    this.rawWriteUint32(jspb.utils.split64Low)
};
jspb.BinaryWriter.prototype.rawWriteDouble = function (a) {
    jspb.utils.splitFloat64(a);
    this.rawWriteUint32(jspb.utils.split64Low);
    this.rawWriteUint32(jspb.utils.split64High)
};
jspb.BinaryWriter.prototype.rawWriteBool = function (a) {
    goog.asserts.assert(goog.isBoolean(a));
    this.temp_.push(~~a)
};
jspb.BinaryWriter.prototype.rawWriteEnum = function (a) {
    goog.asserts.assert(a == Math.floor(a));
    goog.asserts.assert(a >= -jspb.BinaryConstants.TWO_TO_31 && a < jspb.BinaryConstants.TWO_TO_31);
    this.rawWriteSignedVarint32(a)
};
jspb.BinaryWriter.prototype.rawWriteUtf8String = function (a) {
    for (var b = 0; b < a.length; b++)this.temp_.push(a.charCodeAt(b))
};
jspb.BinaryWriter.prototype.rawWriteBytes = function (a) {
    this.appendUint8Array_(a)
};
jspb.BinaryWriter.prototype.rawWriteByteRange = function (a, b, c) {
    this.appendUint8Array_(a.subarray(b, c))
};
jspb.BinaryWriter.prototype.rawWriteVarintHash64 = function (a) {
    jspb.utils.splitHash64(a);
    this.rawWriteSplitVarint(jspb.utils.split64Low, jspb.utils.split64High)
};
jspb.BinaryWriter.prototype.rawWriteFixedHash64 = function (a) {
    jspb.utils.splitHash64(a);
    this.rawWriteUint32(jspb.utils.split64Low);
    this.rawWriteUint32(jspb.utils.split64High)
};
jspb.BinaryWriter.prototype.rawWriteFieldHeader_ = function (a, b) {
    goog.asserts.assert(1 <= a && a == Math.floor(a));
    this.rawWriteUnsignedVarint32(8 * a + b)
};
...
jspb.BinaryWriter.prototype.writeUnsignedVarint32_ = function (a, b) {
    null != b && (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT), this.rawWriteSignedVarint32(b))
};
jspb.BinaryWriter.prototype.writeSignedVarint32_ = function (a, b) {
    null != b && (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT), this.rawWriteSignedVarint32(b))
};
jspb.BinaryWriter.prototype.writeVarint_ = function (a, b) {
    null != b && (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT), this.rawWriteVarint(b))
};
jspb.BinaryWriter.prototype.writeZigzagVarint32_ = function (a, b) {
    null != b && (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT), this.rawWriteZigzagVarint32(b))
};
jspb.BinaryWriter.prototype.writeZigzagVarint_ = function (a, b) {
    null != b && (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT), this.rawWriteZigzagVarint(b))
};
...
jspb.BinaryWriter.prototype.writeInt64 = function (a, b) {
    null != b && (goog.asserts.assert(b >= -jspb.BinaryConstants.TWO_TO_63 && b < jspb.BinaryConstants.TWO_TO_63), this.writeVarint_(a, b))
};
jspb.BinaryWriter.prototype.writeInt64String = function (a, b) {
    if (null != b) {
        var c = jspb.arith.Int64.fromString(b);
        this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT);
        this.rawWriteVarintFromNum(c)
    }
};
...
jspb.BinaryWriter.prototype.writeUint64 = function (a, b) {
    null != b && (goog.asserts.assert(0 <= b && b < jspb.BinaryConstants.TWO_TO_64), this.writeVarint_(a, b))
};
...
jspb.BinaryWriter.prototype.writeSint64 = function (a, b) {
    null != b && (goog.asserts.assert(b >= -jspb.BinaryConstants.TWO_TO_63 && b < jspb.BinaryConstants.TWO_TO_63), this.writeZigzagVarint_(a, b))
};
jspb.BinaryWriter.prototype.writeFixed32 = function (a, b) {
    null != b && (goog.asserts.assert(0 <= b && b < jspb.BinaryConstants.TWO_TO_32), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.FIXED32), this.rawWriteUint32(b))
};
jspb.BinaryWriter.prototype.writeFixed64 = function (a, b) {
    null != b && (goog.asserts.assert(0 <= b && b < jspb.BinaryConstants.TWO_TO_64), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.FIXED64), this.rawWriteUint64(b))
};
jspb.BinaryWriter.prototype.writeSfixed32 = function (a, b) {
    null != b && (goog.asserts.assert(b >= -jspb.BinaryConstants.TWO_TO_31 && b < jspb.BinaryConstants.TWO_TO_31), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.FIXED32), this.rawWriteInt32(b))
};
jspb.BinaryWriter.prototype.writeSfixed64 = function (a, b) {
    null != b && (goog.asserts.assert(b >= -jspb.BinaryConstants.TWO_TO_63 && b < jspb.BinaryConstants.TWO_TO_63), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.FIXED64), this.rawWriteInt64(b))
};
jspb.BinaryWriter.prototype.writeFloat = function (a, b) {
    null != b && (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.FIXED32), this.rawWriteFloat(b))
};
jspb.BinaryWriter.prototype.writeDouble = function (a, b) {
    null != b && (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.FIXED64), this.rawWriteDouble(b))
};
jspb.BinaryWriter.prototype.writeBool = function (a, b) {
    null != b && (goog.asserts.assert(goog.isBoolean(b)), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT), this.temp_.push(~~b))
};
jspb.BinaryWriter.prototype.writeEnum = function (a, b) {
    null != b && (goog.asserts.assert(b >= -jspb.BinaryConstants.TWO_TO_31 && b < jspb.BinaryConstants.TWO_TO_31), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT), this.rawWriteSignedVarint32(b))
};
jspb.BinaryWriter.prototype.writeString = function (a, b) {
    if (null != b) {
        ...
        for (var c = [], d = 0; d < b.length; d++) {
            ...
            128 > e ? c.push(e) : (2048 > e ? c.push(e >> 6 | 192) : (c.push(e >> 12 | 224), c.push(e >> 6 & 63 | 128)), c.push(e & 63 | 128))
        }
        this.rawWriteUnsignedVarint32(c.length);
        this.appendArray_(c)
    }
};
jspb.BinaryWriter.prototype.writeBytes = function (a, b, c, d, e, f) {
    null != b ? (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.DELIMITED), this.rawWriteUnsignedVarint32(b.length), this.rawWriteBytes(jspb.utils.byteSourceToUint8Array(b, f))) : null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writeBytesRawString = function (a, b) {
    this.writeBytes(a, b, null, null, null, !0)
};
jspb.BinaryWriter.prototype.writeMessage = function (a, b, c, d, e, f) {
    null !== b ? (a = this.beginDelimited_(a), c(b, this), this.endDelimited_(a)) : d && null != e && null != f && this.rawWriteByteRange(d, e, f)
};
jspb.BinaryWriter.prototype.writeGroup = function (a, b, c) {
    b && (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.START_GROUP), c(b, this), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.END_GROUP))
};
jspb.BinaryWriter.prototype.writeFixedHash64 = function (a, b) {
    null != b && (goog.asserts.assert(8 == b.length), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.FIXED64), this.rawWriteFixedHash64(b))
};
jspb.BinaryWriter.prototype.writeVarintHash64 = function (a, b) {
    null != b && (goog.asserts.assert(8 == b.length), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT), this.rawWriteVarintHash64(b))
};
...
jspb.BinaryWriter.prototype.writeRepeatedVarint_ = function (a, b) {
    if (null != b)for (var c = 0; c < b.length; c++)this.writeVarint_(a, b[c])
};
...
jspb.BinaryWriter.prototype.writeRepeatedZigzag_ = function (a, b) {
    if (null != b)for (var c = 0; c < b.length; c++)this.writeZigzagVarint_(a, b[c])
};
...
jspb.BinaryWriter.prototype.writeRepeatedInt64 = jspb.BinaryWriter.prototype.writeRepeatedVarint_;
...
jspb.BinaryWriter.prototype.writeRepeatedUint64 = jspb.BinaryWriter.prototype.writeRepeatedVarint_;
...
jspb.BinaryWriter.prototype.writeRepeatedBytes = function (a, b, c, d, e, f) {
    if (null != b)for (c = 0; c < b.length; c++)this.writeBytes(a, b[c], null, null, null, f); else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writeRepeatedBytesRawString = function (a, b) {
    this.writeRepeatedBytes(a, b, null, null, null, !0)
};
jspb.BinaryWriter.prototype.writeRepeatedMessage = function (a, b, c, d, e, f) {
    if (b)for (d = 0; d < b.length; d++)e = this.beginDelimited_(a), c(b[d], this), this.endDelimited_(e); else d && null != e && null != f && this.rawWriteByteRange(d, e, f)
};
jspb.BinaryWriter.prototype.writeRepeatedGroup = function (a, b, c) {
    if (b)for (var d = 0; d < b.length; d++)this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.START_GROUP), c(b[d], this), this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.END_GROUP)
};
...
jspb.BinaryWriter.prototype.writePackedUnsignedVarint32_ = function (a, b, c, d, e) {
    if (null != b && b.length) {
        a = this.beginDelimited_(a);
        for (c = 0; c < b.length; c++)this.rawWriteUnsignedVarint32(b[c]);
        this.endDelimited_(a)
    } else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedSignedVarint32_ = function (a, b, c, d, e) {
    if (null != b && b.length) {
        a = this.beginDelimited_(a);
        for (c = 0; c < b.length; c++)this.rawWriteSignedVarint32(b[c]);
        this.endDelimited_(a)
    } else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedVarint_ = function (a, b, c, d, e) {
    if (null != b && b.length) {
        a = this.beginDelimited_(a);
        for (c = 0; c < b.length; c++)this.rawWriteVarint(b[c]);
        this.endDelimited_(a)
    } else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedZigzag_ = function (a, b, c, d, e) {
    if (null != b && b.length) {
        a = this.beginDelimited_(a);
        for (c = 0; c < b.length; c++)this.rawWriteZigzagVarint(b[c]);
        this.endDelimited_(a)
    } else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
...
jspb.BinaryWriter.prototype.writePackedInt32String = function (a, b) {
    if (null != b && b.length) {
        for (var c = this.beginDelimited_(a), d = 0; d < b.length; d++)this.rawWriteSignedVarint32(parseInt(b[d], 10));
        this.endDelimited_(c)
    }
};
jspb.BinaryWriter.prototype.writePackedInt64 = jspb.BinaryWriter.prototype.writePackedVarint_;
...
jspb.BinaryWriter.prototype.writePackedUint32String = function (a, b) {
    if (null != b && b.length) {
        for (var c = this.beginDelimited_(a), d = 0; d < b.length; d++)this.rawWriteUnsignedVarint32(parseInt(b[d], 10));
        this.endDelimited_(c)
    }
};
jspb.BinaryWriter.prototype.writePackedUint64 = jspb.BinaryWriter.prototype.writePackedVarint_;
...
jspb.BinaryWriter.prototype.writePackedSint32 = jspb.BinaryWriter.prototype.writePackedZigzag_;
jspb.BinaryWriter.prototype.writePackedSint64 = jspb.BinaryWriter.prototype.writePackedZigzag_;
jspb.BinaryWriter.prototype.writePackedFixed32 = function (a, b, c, d, e) {
    if (null != b && b.length)for (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.DELIMITED), this.rawWriteUnsignedVarint32(4 * b.length), a = 0; a < b.length; a++)this.rawWriteUint32(b[a]); else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedFixed64 = function (a, b, c, d, e) {
    if (null != b && b.length)for (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.DELIMITED), this.rawWriteUnsignedVarint32(8 * b.length), a = 0; a < b.length; a++)this.rawWriteUint64(b[a]); else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedSfixed32 = function (a, b, c, d, e) {
    if (null != b && b.length)for (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.DELIMITED), this.rawWriteUnsignedVarint32(4 * b.length), a = 0; a < b.length; a++)this.rawWriteInt32(b[a]); else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedSfixed64 = function (a, b, c, d, e) {
    if (null != b)for (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.DELIMITED), this.rawWriteUnsignedVarint32(8 * b.length), a = 0; a < b.length; a++)this.rawWriteInt64(b[a]); else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedFloat = function (a, b, c, d, e) {
    if (null != b && b.length)for (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.DELIMITED), this.rawWriteUnsignedVarint32(4 * b.length), a = 0; a < b.length; a++)this.rawWriteFloat(b[a]); else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedDouble = function (a, b, c, d, e) {
    if (null != b && b.length)for (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.DELIMITED), this.rawWriteUnsignedVarint32(8 * b.length), a = 0; a < b.length; a++)this.rawWriteDouble(b[a]); else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedBool = function (a, b, c, d, e) {
    if (null != b && b.length)for (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.DELIMITED), this.rawWriteUnsignedVarint32(b.length), a = 0; a < b.length; a++)this.rawWriteBool(b[a]); else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedEnum = function (a, b, c, d, e) {
    if (null != b && b.length) {
        a = this.beginDelimited_(a);
        for (c = 0; c < b.length; c++)this.rawWriteEnum(b[c]);
        this.endDelimited_(a)
    } else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedFixedHash64 = function (a, b, c, d, e) {
    if (null != b && b.length)for (this.rawWriteFieldHeader_(a, jspb.BinaryConstants.WireType.DELIMITED), this.rawWriteUnsignedVarint32(8 * b.length), a = 0; a < b.length; a++)this.rawWriteFixedHash64(b[a]); else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
jspb.BinaryWriter.prototype.writePackedVarintHash64 = function (a, b, c, d, e) {
    if (null != b && b.length) {
        a = this.beginDelimited_(a);
        for (c = 0; c < b.length; c++)this.rawWriteVarintHash64(b[c]);
        this.endDelimited_(a)
    } else null != c && null != d && null != e && this.rawWriteByteRange(c, d, e)
};
